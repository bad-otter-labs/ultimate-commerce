...
foreach (array(
    ...
    "'ultimate_commerce_order_view_model'" => $orderSource,
    "'ultimate_commerce_account_view_model'" => $accountSource,
    "'ultimate_commerce_account_view_model_ready'" => $hooksSource,
    "'ultimate_commerce_order_view_model_ready'" => $hooksSource,
